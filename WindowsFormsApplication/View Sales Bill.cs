...
{
    public partial class View_Sales_Bill : Form
    {
        ...
        public View_Sales_Bill()
        {
            InitializeComponent();
        }

        private void View_Sales_Bill_Load(object sender, EventArgs e)
        {
            FillGrid();
            totalBills();
        }
        ...
        {
            UpdateSalesBill usb = new UpdateSalesBill();
            usb.txtBillNo.Text = this.dataGridView1.CurrentRow.Cells[0].Value.ToString();
            usb.txtBillTotal.Text = this.dataGridView1.CurrentRow.Cells[3].Value.ToString();
           // usb.txtDiscount.Text = this.dataGridView1.CurrentRow.Cells[4].Value.ToString();
            usb.txtNetPay.Text = this.dataGridView1.CurrentRow.Cells[5].Value.ToString();
            usb.Show(); // to open update bill 
